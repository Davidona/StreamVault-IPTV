...
Cadence: one screenshot every 2 seconds  
Window: 61 screenshots per channel, approximately 2 minutes
...
- Log evidence: the media-session/Now Playing trace remained in state `3` for this channel; no fatal error, stuck-player timeout, or MPEG-TS fallback appeared in the captured log.
- Result: PASS.
