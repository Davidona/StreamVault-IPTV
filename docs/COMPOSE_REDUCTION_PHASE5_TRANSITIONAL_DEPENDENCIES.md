...
the live source switcher, Home quick-filter chip row, Home reorder top bar, and
Home channel row surface are now feature-owned while the Home screen/dialog
composition remains in `:app`.
