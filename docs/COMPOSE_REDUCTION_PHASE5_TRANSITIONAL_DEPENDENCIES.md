...
category picker, compact guide-program dialog, and the guide control rows are
now feature-owned
...
compact guide-program dialog and guide control rows are independent of app code;
