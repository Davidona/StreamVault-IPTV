...
category picker, compact guide-program dialog, guide control rows, and EPG
preview pane are now feature-owned
...
compact guide-program dialog, guide control rows, and EPG preview pane are
